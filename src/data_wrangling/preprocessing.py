...
"""This script prepossesses the Airbnb listing data and prepares it for the 
model building. This preprocessing phase is all about removing unnecessary 
columns and prepare the data for EDA.

Usage: preprocessing.py --output_file_path=<output_file_path> --input_file_path=<input_file_path>
 
Options:
--output_file_path=<output_file_path>		Path to folder and file name where 
the preprocessing data will be saved, including the name, `in quotes.
--input_file_path=<input_file_path>			Path to folder and file name where 
the clean file is stored, including the name, `in quotes.
"""
...
def main(output_file_path, input_file_path):
    ...
    preprocessed_drop_columns = ['listing_url', 'neighborhood_overview', 
                                 'host_id', 'host_url','host_name', 
                                 'host_location', 'host_about', 
                                 'host_response_time','host_response_rate', 
                                 'host_acceptance_rate', 'host_picture_url',
                                 'host_total_listings_count', 
                                 'host_verifications', 'host_identity_verified',
                                 'property_type', 'bathrooms_text', 'bedrooms',
